...
def handle(req):
    ...
    try:
        ...
        return ("ERROR: get-db-to-json: Invalid Configuration file\n")
    ...
    try:
        ...
        return ("ERROR: get-db-to-json: Unable to connect to Billing database\n") 
    cur = db.cursor()

    #Prepare the query

    #TODO: We have taken a scenario of single table, with a single primary key.
    ...
    if not db_result:
       return ("ERROR: get-db-to-json:No record returned from Billing database\n")
